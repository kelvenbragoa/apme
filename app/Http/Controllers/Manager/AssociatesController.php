...
public function show($id){
    ...
    $associate = User::with('role')->with('associatecompany')->with('associatecompany.province')->with('associatecompany.frequency')->with('quotes')->find($id);
...
public function edit($id){
    $associate = User::with('role')->with('associatecompany')->with('associatecompany.province')->with('associatecompany.frequency')->find($id);
