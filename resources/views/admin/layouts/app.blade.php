    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <router-link to="/admin/dashboard" class="text-nowrap logo-img">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/dashboard" aria-expanded="false">
                <span>
            ...
            {{-- <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/activity" aria-expanded="false">
                <span>
                  <i class="ti ti-user"></i>
                </span>
                <span class="hide-menu">Atividadees</span>
              </router-link>
            </li> --}}
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/admins" aria-expanded="false">
                <span>
                  <i class="ti ti-user"></i>
                </span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/managers" aria-expanded="false">
                <span>
                  <i class="ti ti-user"></i>
                </span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/associates" aria-expanded="false">
                <span>
                  <i class="ti ti-user"></i>
                </span>
                <span class="hide-menu">Associados</span>
              </router-link>
            </li>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/expenses" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/quotes" aria-expanded="false">
                <span>
                  <i class="ti ti-analyze"></i>
                </span>
                <span class="hide-menu">Quotas Associados</span>
              </router-link>
            </li>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/events" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/calendars" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/notifications" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/configurations" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <router-link class="sidebar-link" to="/admin/products" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <router-link class="nav-link nav-icon-hover"to="/admin/notifications" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <hr>
                      ...
                      <router-link class="d-flex align-items-center gap-2 dropdown-item"  to="/admin/configurations" aria-expanded="false">
