...
const getAssociate = () => {
  axios.get('/associate-associates/edit')
       .then((response)=>{
...
axios.delete(`/associate-activity-associates/${activityIdBeingDeleted}`)
.then(()=>{
...
<template>
  <div v-if="!loadingDiv">
    <router-link to="/associate/associates" >
          ...
          <div class="card-body">
            ...
            <Form @submit="editAssociateFunction" :validation-schema="schema" v-slot="{ errors }">
              ...
              <div class="mb-3">
                        ...
                        <Field type="text" class="form-control" :class="{'is-invalid':errors.associate_number}" v-model="associate_data.associatecompany.associate_number" readonly disabled  name="associate_number" id="associate_number" aria-describedby="associate_number"/>
                    ...
                    <div class="mb-3">
                        ...
                        <Field type="text" class="form-control" :class="{'is-invalid':errors.company_name}" v-model="associate_data.associatecompany.company_name" readonly disabled name="company_name" id="company_name" aria-describedby="company_name"/>
                    ...
                    <div class="mb-3">
                        ...
                        <Field class="form-control" :class="{'is-invalid':errors.province_id}" v-model="associate_data.associatecompany.province.name"  name="province_id" readonly disabled id="provinceId" aria-describedby="provinceId"/>
                        <span class="invalid-feedback">{{ errors.province_id }}</span>
                    </div>
                    <div class="mb-3">
                        <label for="accession_date" class="form-label">Data da Adesão</label>
                        <Field type="date" class="form-control" :class="{'is-invalid':errors.accession_date}" v-model="associate_data.associatecompany.accession_date" readonly disabled name="accession_date" id="accession_date" aria-describedby="accession_date"/>
                    ...
                    <div class="mb-3">
                        ...
                        <Field  class="form-control" :class="{'is-invalid':errors.payment_frequency_id}" v-model="associate_data.associatecompany.frequency.name" readonly disable name="payment_frequency_id" id="paymentFrequencyId" aria-describedby="paymentFrequencyId"/>
                    ...
                    <div class="mb-3">
                        ...
                        <Field type="email" class="form-control" :class="{'is-invalid':errors.user_email}" v-model="associate_data.email" readonly disabled name="user_email" id="user_email" aria-describedby="user_email"/>
