...
const form = reactive({
 ...
 const getConfigurationList = async () => {
  axios.get('/manager-configurations')
       .then((response)=>{
...
const createCategoryFunction = (values, {resetForm}) => {
  axios.post('/manager-configurations',values).then((response)=>{
...
const deleteNotification = () =>{
  ...
  axios.delete(`/manager-configurations/${userIdBeingDeleted}`)
  .then(()=>{
...
const editConfigurationFunction = (values, actions) => {
  ...
  errorMessage.value = '';
  axios.post('/manager-changepassword',values).then((response)=>{
