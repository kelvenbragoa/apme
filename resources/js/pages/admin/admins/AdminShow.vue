...
const getAdmin = () => {
  axios.get(`/admins/+${router.currentRoute.value.params.id}`)
       .then((response)=>{
        loading.value=false;
    ...
    <div v-if="!loading">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p><strong>Telefone:</strong> {{ admin.mobile }}</p>
                <p><strong>Email:</strong> {{ admin.email }}</p>
                <p><strong>Nível:</strong> {{ admin.role.name }}</p>
                <p><strong>Registrado em:</strong> {{ admin.data }}</p>
