...
const deleteManager = () =>{
  ...
  axios.delete(`/managers/${userIdBeingDeleted}`)
  .then(()=>{
...
<div v-if="!loadingDiv">
    <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <router-link to="/admin/managers/create"  class="btn btn-primary m-2">
  ...
  <tbody v-if="managers.data.length > 0">
    <tr v-for="(manager,index) in managers.data" :key="manager.id">
      ...
      <td>
        <router-link :to="'/admin/managers/'+manager.id+'/edit'"><i class="ti ti-edit"></i></router-link>
        <router-link :to="'/admin/managers/'+manager.id"><i class="ti ti-eye"></i></router-link>
