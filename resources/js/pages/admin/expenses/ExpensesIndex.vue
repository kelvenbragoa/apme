...
const deleteExpense = () =>{
  ...
  axios.delete(`/expenses/${userIdBeingDeleted}`)
  .then(()=>{
...
<div v-if="!loadingDiv">
    <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <router-link to="/admin/expenses/create"  class="btn btn-primary m-2">
  ...
  <tbody v-if="expenses.data.length > 0">
    <tr v-for="(expense,index) in expenses.data" :key="expense.id">
      ...
      <td>
        <router-link :to="'/admin/expenses/'+expense.id+'/edit'"><i class="ti ti-edit"></i></router-link>
        <router-link :to="'/admin/expenses/'+expense.id"><i class="ti ti-eye"></i></router-link>
