<script setup>
  ...
  const getAdminCount = ()=>{
    axios.get('/admins/dashboard/admincount',{
      params: {
  ...
  const getManagerCount = ()=>{
    axios.get('/admins/dashboard/managercount',{
      params: {
  ...
  const getAssociateCount = ()=>{
    axios.get('/admins/dashboard/associatecount',{
      params: {
  ...
  const getUserCount = ()=>{
    axios.get('/admins/dashboard/usercount',{
      params: {
  ...
  const getExpenseCount = ()=>{
    axios.get('/admins/dashboard/expensecount',{
      params: {
  ...
  const getQuoteCount = ()=>{
    axios.get('/admins/dashboard/quotecount',{
      params: {
  ...
  const getAllCount = ()=>{
    ...
    axios.get('/admins/dashboard/allcount')
    .then((response)=>{
      totalUserCount.value = response.data.totalUserCount;
      totalAdminCount.value = response.data.totalAdminCount;
      totalManagerCount.value = response.data.totalManagerCount;
      ...
      totalQuoteCount.value = response.data.totalQuoteCount;
      totalQuoteAmount.value = response.data.totalQuoteAmount;
      expenses.value = response.data.last10expenses;
...
<div v-if="!loadingDiv">
            ...
            <p class="mb-0">Painel do Administrador </p>
              ...
              <div class="col-lg-3">
                <div class="card">
                      <div class="card-body">
                        <div class="row alig n-items-start">
                          <div class="col-8">
                            <h5 class="card-title mb-9 fw-semibold"> Gestores </h5>
                            <h4 class="fw-semibold mb-3">{{ totalManagerCount }}</h4>
                            <div class="d-flex align-items-center pb-1">
                              <span
                                class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center">
                                <i class="ti ti-calendar text-danger"></i>
              ...
              <div class="col-lg-3">
                <div class="card">
                      <div class="card-body">
                        <div class="row alig n-items-start">
                          <div class="col-8">
                            <h5 class="card-title mb-9 fw-semibold"> Associados </h5>
                            <h4 class="fw-semibold mb-3">{{ totalAssociateCount }}</h4>
                            <div class="d-flex align-items-center pb-1">
                              <span
                                class="me-2 rounded-circle bg-light-danger round-20 d-flex align-items-center justify-content-center">
                                <i class="ti ti-calendar text-danger"></i>
                              </span>
                              <select name="date_range" @change="getAssociateCount()" v-model="selectedAssociateStatus" class="form-control">
                                <option selected value="total" >Total</option>
                                <option value="today" >Hoje</option>
                                <option value="30" >30 dias</option>
                                <option value="60" >60 dias</option>
